          ...
          <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl w-full max-h-screen overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="grid grid-cols-1 gap-4">
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-2 mt-2">
                      ...
                      <div><span className="font-medium">Gender:</span> {selectedStudent.gender || 'N/A'}</div>
                      <div><span className="font-medium">Phone:</span> {selectedStudent.phoneNumber}</div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 gap-2 mt-2">
                      ...
                      <div><span className="font-medium">City:</span> {selectedStudent.city || 'N/A'}</div>
                      <div><span className="font-medium">State:</span> {selectedStudent.state || 'N/A'}</div>
                      <div><span className="font-medium">Pincode:</span> {selectedStudent.pincode || 'N/A'}</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="grid grid-cols-1 gap-2 mt-2">
                    <div><span className="font-medium">College Roll:</span> {selectedStudent.c_roll}</div>
                    <div><span className="font-medium">Examination Roll:</span> {selectedStudent.e_roll || 'N/A'}</div>
                    <div><span className="font-medium">Course Code:</span> {selectedStudent.course_code}</div>
                    <div><span className="font-medium">Semester:</span> {selectedStudent.sem}</div>
                    <div><span className="font-medium">Rank:</span> {selectedStudent.rank || 'N/A'}</div>
                    <div><span className="font-medium">Payment Status:</span> {selectedStudent.payment ? 'Paid' : 'Not Paid'}</div>
                  </div>
                </div>
                
                <div>
                  <h4 className="font-semibold text-gray-700">Educational Background</h4>
                  <div className="grid grid-cols-1 gap-2 mt-2">
                    <div><span className="font-medium">10th Marks:</span> {selectedStudent.tenth_marks || 'N/A'}</div>
                    <div><span className="font-medium">10th Year:</span> {selectedStudent.tenth_year || 'N/A'}</div>
                    <div><span className="font-medium">12th Marks:</span> {selectedStudent.twelfth_marks || 'N/A'}</div>
                    <div><span className="font-medium">12th Year:</span> {selectedStudent.twelfth_year || 'N/A'}</div>
                  </div>
                </div>
                
                {selectedStudent.ug_name && (
                  <div>
                    <h4 className="font-semibold text-gray-700">Undergraduate Information</h4>
                    <div className="grid grid-cols-1 gap-2 mt-2">
                      <div><span className="font-medium">UG Name:</span> {selectedStudent.ug_name || 'N/A'}</div>
                      <div><span className="font-medium">UG Marks:</span> {selectedStudent.ug_marks || 'N/A'}</div>
                      <div><span className="font-medium">UG Duration:</span> {selectedStudent.ug_start} - {selectedStudent.ug_end}</div>
                    </div>
                  </div>
                )}
                ...
                {selectedStudent.other_course && (
                  <div>
                    <h4 className="font-semibold text-gray-700">Other Course Information</h4>
                    <div className="grid grid-cols-1 gap-2 mt-2">
                      <div><span className="font-medium">Course Name:</span> {selectedStudent.other_course || 'N/A'}</div>
                      <div><span className="font-medium">Marks:</span> {selectedStudent.other_course_marks || 'N/A'}</div>
                      <div><span className="font-medium">Duration:</span> {selectedStudent.other_course_start} - {selectedStudent.other_course_end}</div>
                    </div>
                  </div>
                )}
              </div>
            ...
            <div className="mt-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-2 mt-2">
                <div><span className="font-medium">Created At:</span> {formatDate(selectedStudent.createdAt)}</div>
                <div><span className="font-medium">Updated At:</span> {formatDate(selectedStudent.updatedAt)}</div>
                <div><span className="font-medium">Student ID:</span> {selectedStudent.s_id}</div>
              </div>
            </div>
