...
const TeacherScheduleDisplay = ({ courseId }) => {
  ...
  const semesters = [
    { key: "Semester 1", value: 1 },
    { key: "Semester 2", value: 2 },
    { key: "Semester 3", value: 3 },
    { key: "Semester 4", value: 4 },
    { key: "Semester 5", value: 5 },
    { key: "Semester 6", value: 6 },
    { key: "Semester 7", value: 7 },
    { key: "Semester 8", value: 8 },
  ];
  ...
  useEffect(() => {
    ...
    fetchSchedule();
  }, [id, sem]); // Added sem to dependency array to refetch when semester changes
      ...
      <div className="bg-gradient-to-r from-blue-500 to-indigo-600 py-3 px-4 flex justify-between items-center">
        <div className="flex items-center space-x-4">
          ...
          <select
            ...
            className="bg-white/20 text-white text-sm rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-white/40"
          >
        ...
        <div className="bg-gradient-to-r from-blue-500 to-indigo-600 py-2 px-3 flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <select
              value={sem}
              onChange={(e) => setSem(Number(e.target.value))}
              className="bg-white/20 text-white text-xs rounded px-2 py-1 focus:outline-none focus:ring-2 focus:ring-white/40"
            >
              {semesters.map((semester) => (
                <option
                  key={semester.value}
...
export default TeacherScheduleDisplay;
